        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Actualización de Ventas</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.ventas.update', $venta) }}" method="post" id="formulario_venta">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                            ...
                                            <table
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: right" colspan="1"><b>Precio Total</b></td>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" id="nombre_cliente" value="{{ $venta->cliente->nombre ?? 'S/N' }}" class="form-control">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="fecha_venta"
                                                        value="{{ old('fecha_venta', $venta->fecha_venta) }}" class="form-control">
                                                    @error('fecha_venta')
                                                        <small style="color:red;"> {{ $message }} </small>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-success btn-block"><i
                                                            class="bi bi-save"></i> Actualizar venta</button>
                                                </div>
                                            </div>
                                        </div>
